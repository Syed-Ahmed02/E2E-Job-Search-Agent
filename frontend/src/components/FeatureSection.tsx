        ...
        <section>
            <div className="py-24">
                <div className="mx-auto w-full max-w-5xl px-6">
                    <div>
                        <h2 className="text-foreground max-w-2xl text-balance text-4xl font-semibold">Empowering Job Seekers with AI-driven solutions</h2>
                    </div>
                    <div className="mt-16 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                        <Card
                            className="overflow-hidden p-6">
                            <Target className="text-primary size-5" />
                            <h3 className="text-foreground  text-lg font-semibold">AI Resume Matching</h3>
                            <p className="text-muted-foreground text-balance">Our advanced AI models match your resume to the best jobs for you.</p>

                            <ResumeMatchingIllustration />
                        </Card>
...
const ResumeMatchingIllustration = () => {
    return (
        <Card
            aria-hidden
            ...
            <div className="mb-0.5 text-sm font-semibold">AI Resume Matching</div>
            <div className="mb-4 flex text-sm">
                <span className="text-muted-foreground">We found 15 jobs that match your resume</span>
            </div>
            ...
            <div className="text-muted-foreground text-sm font-medium">View Jobs</div>
        </Card>
    )
}
